<template>
  <div id="app">
    <!-- header + jumbotron -->
    <AppHeader :navItems="headerMenu" @clickEvent="changeActive" />
    <!-- /header + jumbotron -->
...
export default {
  ...
  methods: {
    changeActive(index) {
      ...
      if (this.headerMenu[index].active) {
        this.headerMenu[index].active = false;
      } else if (!this.headerMenu[index].active) {
